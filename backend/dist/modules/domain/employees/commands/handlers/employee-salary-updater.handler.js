...
let EmployeeSalaryUpdater = class EmployeeSalaryUpdater extends commands_1.BaseCommandHandler {
    ...
    handle(command) {
        return __awaiter(this, void 0, void 0, function* () {
            const { employeeId, salary } = command;
...
//# sourceMappingURL=employee-salary-updater.handler.js.map